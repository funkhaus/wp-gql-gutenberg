...
class Schema {
	function __construct() {
		...
		new \WPGraphQLGutenberg\Schema\Types\Connection\CoreCoverBlockMediaItemConnection();
		new \WPGraphQLGutenberg\Schema\Types\Connection\CoreGalleryBlockMediaItemsConnection();
